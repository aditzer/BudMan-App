...
class ActiveGoalCard extends StatelessWidget {
  ...
  ActiveGoalCard({Key? key,required this.targetAmount,required this.goalName,required this.savedAmount,required this.desiredDate,required this.onClickPause,required this.onClickAddAmount, required this.onClickDelete,required this.onClickComplete}) : super(key: key);
              ...
              child: Center(
                child: Row(
                  children: [
                    ...
                    Expanded(
                        child: Text(desiredDate,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.blue),)
                    ),
                  ],
                ),
              ),
